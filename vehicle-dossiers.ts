...
export const VEHICLE_DOSSIERS: Record<string, VehicleDossier> = {
  ...
  enterprise: {
    ...
    facts: [
      ...
      "Warp 8 is the Constitution class's emergency maximum.",
      "The original-series cubic convention maps Warp 8 to approximately 512c.",
      "At that setting benchmark, the present Proxima distance takes about three days.",
    ],
  ...
  "millennium-falcon": {
    ...
    media: {
      src: falconSrc,
      alt: "Millennium Falcon entering hyperspace in an official Lucasfilm image",
    ...
    facts: [
      ...
      "Its upgraded Class 0.5 hyperdrive is exceptionally fast in-setting.",
      "A widely circulated Legends-era estimate places its effective speed near 150,000c.",
      "At that estimate, the present Proxima distance takes about 14.9 minutes.",
    ],
    ...
    canonicalNote: "The image and basic identity come from the official Star Wars Databank; the 150,000c number is identified separately as a Legends-era community estimate.",
  },
  droplet: {
    vehicleId: "droplet",
    media: {
    ...
    facts: [
      ...
      "Later in the trilogy, droplets are explicitly detected at 25,000 km/s.",
      "That maximum is about 8.3% of light speed and gives a 50.9-year Proxima distance comparison.",
  ...
  warhammer: {
    ...
    facts: [
      ...
      "Imperial accounts place short Warp passages anywhere from hours to weeks.",
      "Hostile currents and time displacement can turn the same route into something far worse.",
    ],
    ...
    canonicalNote: "The image is the named ship's official Battlefleet Gothic: Armada II adaptation; the hours-to-weeks-or-worse result expresses the setting's Warp-travel range.",
  },
};
